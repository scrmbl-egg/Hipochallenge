...
# check how many flare arrows the player has in their inventory (clear 0 results
#  in the amount of items detected)
...
# if has less than max amount of projectiles, give projectile and set faster
# cooldown
