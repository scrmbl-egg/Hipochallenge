#>hc:abilities/class/tank/kit3/on_redirect_spirit_used
#
...
function hc:abilities/cooldown/handle_item_cd {item_id:tank_k3_redirect_spirit,cd_score:tank_kit3_redirect_spirit_cd}
