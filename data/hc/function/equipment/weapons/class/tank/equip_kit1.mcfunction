...
item modify entity @s hotbar.0 hc:weapons/class/tank/kit1/sword

# castle item
item replace entity @s hotbar.1 with paper
item modify entity @s hotbar.1 hc:weapons/class/tank/kit1/castle

# goat horn (not given if perk == 3)
execute unless predicate hc:perk/is_perk3 run item replace entity @s hotbar.2 with paper
execute unless predicate hc:perk/is_perk3 run item modify entity @s hotbar.2 hc:weapons/class/tank/kit1/goat_horn
