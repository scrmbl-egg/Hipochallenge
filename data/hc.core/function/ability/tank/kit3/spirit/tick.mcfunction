#>hc.core:ability/tank/kit3/spirit/tick
#
...
# run ambient fx
execute as @s at @s run function hc.core:fx/ability/tank/kit3/spirit_ambient

# spawn goal marker
execute at @s \
    run \
    function hc.core:ability/tank/kit3/spirit/summon_goal \
...
execute at @s \
    run \
    function hc.core:ability/tank/kit3/spirit/move \
    with entity @s data."hc:entity/spirit"
