...
execute as @e[ \
    ...
    at @s \
    run \
    function hc.core:projectile/class/tank/trident/tick
...
execute as @e[ \
    ...
    run \
    function hc.core:projectile/set_no_gravity
...
execute as @e[ \
    ...
    at @s \
    run \
    function hc.core:projectile/arrow/clean
