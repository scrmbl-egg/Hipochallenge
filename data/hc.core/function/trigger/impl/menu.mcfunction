...
execute if entity @s[advancements={hc.core:training/used_training_menu=true}] \
    run \
    trigger menu
...
advancement revoke @s only hc.core:training/used_training_menu
...
#dialog show @s hc.core:training/menu
