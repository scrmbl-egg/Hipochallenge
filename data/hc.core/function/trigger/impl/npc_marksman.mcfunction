#>hc.core:trigger/impl/npc_marksman
#
...
execute unless predicate { \
    ...
    terms:[ \
        { \
            ...
            entity:"this", \
            scores:{ \
                npc_marksman:{min:-2147483648,max:-1}, \
            }, \
        }, \
        { \
            condition:"minecraft:entity_scores", \
            entity:"this", \
            scores:{ \
                npc_marksman:{min:1,max:2147483647}, \
            }, \
        }, \
    ], \
} \
    ...
    summon minecraft:mannequin ~ ~ ~ { \
        ...
        description:{ \
            ...
            with:[ \
                ...
                {translate:"hc.class.marksman.icon",fallback:"\ud83c\udff9"}, \
            ], \
        }, \
    }
...
data modify entity @n[tag=__hc.NewNpc] description.with[1] \
    ...
    classes[{internal_name:"hc:marksman"}].list_info.class_text_style
