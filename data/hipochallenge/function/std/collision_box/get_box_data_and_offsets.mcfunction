...
scoreboard players operation $init_x local_000 /= $two local_000
scoreboard players operation $init_y local_000 /= $two local_000
scoreboard players operation $init_z local_000 /= $two local_000
