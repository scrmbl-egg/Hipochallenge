# params:
    ...
    # dx_const  (volume x component)
    # dy_const  (volume y component)
    # dz_const  (volume z component)
...
$data modify storage minecraft:hipochallenge local_param_dx set from storage minecraft:hipochallenge $(dx_const)
$data modify storage minecraft:hipochallenge local_param_dy set from storage minecraft:hipochallenge $(dy_const)
$data modify storage minecraft:hipochallenge local_param_dz set from storage minecraft:hipochallenge $(dz_const)
...
# get selector volumes (we subtract one block)
