...
execute as @s run function std:array/map {arr_st:"minecraft:hipochallenge",arr_path:"local_effect_arr",fn:"hipochallenge:mechanics/suppression/effects/give_effects/unwrap_effect_and_apply_st",fn_st:"minecraft:hipochallenge",elem_macro:"current_elem"}
