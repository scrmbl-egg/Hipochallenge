...
function hipochallenge:msg/all/inject_text/msg_all_inject {txt:"{\"translate\":\"hc.msg.all.team2_changed_name_to\",\"fallback\":\"The first team is now called %s\",\"with\":[{\"translate\":\"hc.teams.team2.default_name\",\"fallback\":\"%s\",\"with\":[{\"nbt\":\"team2_name\",\"storage\":\"minecraft:hipochallenge\"}]}]}"}
