#>hipochallenge:equipment/armor/equip_support_armor
#
# Equips the support class armor, with the team context's armor color and trim
# material.
...
# attributes
function hipochallenge:attribute/class/base/set_support_attributes

# equip default/neutral armor
loot replace entity @s armor.head loot hipochallenge:class/armor/support/head
loot replace entity @s armor.chest loot hipochallenge:class/armor/support/chest
loot replace entity @s armor.legs loot hipochallenge:class/armor/support/legs
loot replace entity @s armor.feet loot hipochallenge:class/armor/support/feet
