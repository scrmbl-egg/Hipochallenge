#>hipochallenge:equipment/armor/equip_marksman_armor
#
# Equips the marksman class armor, with the team context's armor color and trim
# material.
...
# attributes
function hipochallenge:attribute/class/base/set_marksman_attributes

# equip default/neutral armor
loot replace entity @s armor.head loot hipochallenge:class/armor/marksman/head
loot replace entity @s armor.chest loot hipochallenge:class/armor/marksman/chest
loot replace entity @s armor.legs loot hipochallenge:class/armor/marksman/legs
loot replace entity @s armor.feet loot hipochallenge:class/armor/marksman/feet
