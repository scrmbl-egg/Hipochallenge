#>hipochallenge:equipment/armor/equip_recon_armor
#
# Equips the recon class armor, with the team context's armor color and trim
# material.
...
# attributes
function hipochallenge:attribute/class/base/set_recon_attributes

# equip default/neutral armor
loot replace entity @s armor.head loot hipochallenge:class/armor/recon/head
loot replace entity @s armor.chest loot hipochallenge:class/armor/recon/chest
loot replace entity @s armor.legs loot hipochallenge:class/armor/recon/legs
loot replace entity @s armor.feet loot hipochallenge:class/armor/recon/feet
