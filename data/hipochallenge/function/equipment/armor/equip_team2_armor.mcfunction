...
$execute as @s if predicate hipochallenge:class/is_ranger run function hipochallenge:equipment/armor/class/equip_ranger_armor {team_trim:$(team2_trim),team_armor_color:$(team2_armor_color)}
