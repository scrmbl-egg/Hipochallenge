...
item modify entity @s hotbar.0 hipochallenge:weapons/class/tank/kit1/sword

# castle item
item replace entity @s hotbar.1 with paper
item modify entity @s hotbar.1 hipochallenge:weapons/class/tank/kit1/castle
...
execute unless predicate hipochallenge:perk/is_perk3 run item modify entity @s hotbar.2 hipochallenge:weapons/class/tank/kit1/goat_horn
