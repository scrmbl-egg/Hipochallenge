...
execute as @s[team=!admin,team=!spectator] if predicate hipochallenge:class/has_all_options_selected run function hipochallenge:list_info/display_list_info_st with storage minecraft:hipochallenge
