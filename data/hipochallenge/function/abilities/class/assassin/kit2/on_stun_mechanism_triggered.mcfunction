#>hipochallenge:abilities/class/assassin/kit2/on_stun_mechanism_triggered
#
...
execute unless predicate hipochallenge:team/is_in_pvp_team \
    run \
    return run \
...
execute if predicate hipochallenge:mechanic/is_silenced \
    run \
    return run \
