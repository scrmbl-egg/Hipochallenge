...
execute if items entity @s weapon.* goat_horn[custom_data={item_id:tank_k1_goat_horn}] at @s run function hipochallenge:vfx/abilities/class/tank/kit1/goat_horn_indicator_st with storage minecraft:hipochallenge
