...
# in:
    # local_effect_amplifier
execute as @s if score @s tank_kit2_goat_horn_nearby_enemies matches 1.. run function hipochallenge:abilities/class/tank/kit2/goat_horn/give_resistance_effect_st with storage minecraft:hipochallenge
