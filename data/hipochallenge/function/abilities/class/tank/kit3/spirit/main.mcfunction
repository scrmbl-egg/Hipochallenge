...
execute as @s at @s run function hipochallenge:abilities/class/tank/kit3/spirit/get_info_st with storage hipochallenge

# run

execute as @s at @s run function hipochallenge:abilities/class/tank/kit3/spirit/player_finder_st with storage hipochallenge
...
execute as @s at @s run function hipochallenge:abilities/class/tank/kit3/spirit/buff_st with storage hipochallenge
