...
execute on vehicle at @s run tp @s ^ ^ ^0.3
execute on vehicle at @s if entity @n[nbt={data:{id:445}},type=minecraft:marker,distance=5..] run tp @s ^ ^ ^0.3
execute on vehicle at @s if entity @n[nbt={data:{id:445}},type=minecraft:marker,distance=10..] run tp @s ^ ^ ^0.3
