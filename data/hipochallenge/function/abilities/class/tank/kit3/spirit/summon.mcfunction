#>hipochallenge:abilities/class/tank/kit3/spirit/summon
#
...
execute as @s \
    run \
    function hipochallenge:abilities/class/tank/kit3/spirit/attribute_modifiers/owner_apply
...
execute as @s \
    run \
    function hipochallenge:abilities/class/tank/kit3/spirit/attribute_modifiers/target_apply
