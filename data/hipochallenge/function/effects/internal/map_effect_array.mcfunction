...
execute if score $give_suppression local_suppr_score matches 1.. run function hipochallenge:mechanics/suppression/add_secs with storage minecraft:hipochallenge local_current_effect
