#>hipochallenge:team/color/set_team2_purple
#
# Sets the second team's color to purple.
...
data modify storage minecraft:hipochallenge local_set_color.msg.text.with[1] \
    ...
    consts.team_presets[{internal_name:"purple"}].default_name
data modify storage \
    minecraft:hipochallenge local_set_color.msg.text.with[1].color \
    set from storage \
    minecraft:hipochallenge \
    consts.team_presets[{internal_name:"purple"}].text_color
...
data modify storage minecraft:hipochallenge vars.team_contexts.team2.preset \
    ...
    consts.team_presets[{internal_name:"purple"}]
...
data modify storage minecraft:hipochallenge local_set_color.name.team \
    set value "team2"
data modify storage minecraft:hipochallenge local_set_color.name.color \
    set from storage \
