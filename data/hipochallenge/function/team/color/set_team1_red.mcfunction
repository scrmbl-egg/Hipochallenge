#>hipochallenge:team/color/set_team1_red
#
# Sets the first team's color to red.
...
data modify storage minecraft:hipochallenge local_set_color.msg.text.with[1] \
    ...
    consts.team_presets[{internal_name:"red"}].default_name
data modify storage \
    minecraft:hipochallenge local_set_color.msg.text.with[1].color \
    set from storage \
    minecraft:hipochallenge \
    consts.team_presets[{internal_name:"red"}].text_color
...
data modify storage minecraft:hipochallenge vars.team_contexts.team1.preset \
    ...
    consts.team_presets[{internal_name:"red"}]
