#>hipochallenge:team/color/set_team2_cyan
#
# Sets the second team's color to cyan.
...
data modify storage minecraft:hipochallenge local_set_color.msg.text.with[1] \
    ...
    consts.team_presets[{internal_name:"cyan"}].default_name
data modify storage \
    minecraft:hipochallenge local_set_color.msg.text.with[1].color \
    set from storage \
    minecraft:hipochallenge \
    consts.team_presets[{internal_name:"cyan"}].text_color
...
data modify storage minecraft:hipochallenge vars.team_contexts.team2.preset \
    ...
    consts.team_presets[{internal_name:"cyan"}]
