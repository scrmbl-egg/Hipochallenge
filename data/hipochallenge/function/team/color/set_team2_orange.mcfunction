#>hipochallenge:team/color/set_team2_orange
#
# Sets the second team's color to orange.
...
data modify storage minecraft:hipochallenge local_set_color.msg.text.with[1] \
    ...
    consts.team_presets[{internal_name:"orange"}].default_name
data modify storage \
    minecraft:hipochallenge local_set_color.msg.text.with[1].color \
    set from storage \
    minecraft:hipochallenge \
    consts.team_presets[{internal_name:"orange"}].text_color
...
data modify storage minecraft:hipochallenge vars.team_contexts.team2.preset \
    ...
    consts.team_presets[{internal_name:"orange"}]
