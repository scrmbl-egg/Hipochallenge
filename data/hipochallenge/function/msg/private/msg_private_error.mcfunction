...
$tellraw @s [{"text":"","hoverEvent":{"action":"show_text","value":[{"translate":"hc.msg.private","fallback":"Private message"}]}},{"bold":true,"color":"blue","text":">> "},{"bold":true,"color":"red","text":"["},{"bold":true,"color":"red","translate":"hc.msg.error","fallback":"ERROR"},{"bold":true,"color":"red","text":"] "},{"color":"red","text":"$(msg)"}]
