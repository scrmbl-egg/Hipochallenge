...
data modify storage minecraft:hipochallenge local_scale set from storage minecraft:hipochallenge RECON_ATTRIBUTE_SCALE
data modify storage minecraft:hipochallenge local_burning_time set from storage minecraft:hipochallenge RECON_ATTRIBUTE_BURNING_TIME
