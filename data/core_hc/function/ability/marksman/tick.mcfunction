...
# kit 1
    ...
    # done here
    execute as @a[scores={hc.BowShot=1..}] if items entity @s weapon.* *[custom_data={item_id:marksman_k1_bow}] run function hipochallenge:abilities/class/marksman/kit1/on_bow_shot
